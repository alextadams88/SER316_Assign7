...
public class TaskListImpl implements ITaskList {
    ...
    public Collection getAllSubTasks(String taskId) {
    	if ((taskId == null) || (taskId.length() == 0)) {
            ...
            return TaskImpl.convertToTaskObjects(subTasks, this);    	    		
    	}
    }
...
//            Util.debug("Progress: "+ t.getProgress());
    ...
    private Collection getAllRootTasks() {
        ...
        return TaskImpl.convertToTaskObjects(tasks, this);
    }
    
    //TASK 2-2 SMELL BETWEEN CLASSES
    //removing this code because TaskImpl has the same code
    /*
    ...
    */
    ...
    //TASK 2-2 SMELL BETWEEN CLASSES
    //removing this code because this should be a TaskImpl responsibility
    /*
